...
$_list = array(
	array(
		...
		'brief'=>'Jcseg是使用Java开发的一个轻量级的中文分词器，使用流行的mmseg算法实现。1。目前最高版本：jcseg 1.9.2。兼容最高版本lucene-4.x和最高版本solr-4.x2。mmseg四种过滤算法，分词准确率达到了98.41%。' ),
	array(
        'url'=>'http://code.google.com/p/friso',
        'title'=>'C语言开源高性能中文分词器-friso',
		'git'=>'http://git.oschina.net/lionsoul/friso',
        'brief'=>'Friso是使用c语言开发的一个高性能跨平台的中文分词器，使用流行的mmseg算法实现。完全基于模块化设计和实现，可以很方便的植入到其他程序中，例如：MySQL，PHP等。支持对UTF-8/GBK编码的切分。目前最高版本：friso 1.5.0。' ),
	array(
